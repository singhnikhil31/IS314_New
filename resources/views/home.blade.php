                ...
                <div class="col-lg-8">
                    <div class="main-banner header-text">
                        <div class="Modern-Slider">
                          ...
                          <div class="item">
                            <div class="img-fill">
                                <img src="assets/images/slide-01.jpg" alt="" style="width: 100%; height: 100%; object-fit: contain;">>
                            </div>
                          </div>
                          <!-- // Item -->
                          <!-- Item -->
                          <div class="item">
                            <div class="img-fill">
                                <img src="assets/images/slide-02.jpg" alt="" style="width: 100%; height: 100%; object-fit: contain;">>
                            </div>
                          </div>
                          <!-- // Item -->
                          <!-- Item -->
                          <div class="item">
                            <div class="img-fill">
                                <img src="assets/images/slide-03.jpg" alt="" style="width: 100%; height: 100%; object-fit: contain;">>
                            </div>
                          </div>
                          <!-- // Item -->
                        </div>
